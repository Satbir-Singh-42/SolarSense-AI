    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-800 to-slate-900 p-3 sm:p-4 md:p-6 pt-20">
        <div className="w-full max-w-6xl grid md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 items-center">
          {/* Login Form */}
          <div className="flex justify-center md:justify-end order-2 md:order-1 p-4">
          ...
          <div className="hidden md:flex flex-col justify-center space-y-4 sm:space-y-6 p-4 sm:p-6 lg:p-8 order-1 md:order-2">
            <div className="space-y-3 sm:space-y-4">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-secondary-custom leading-relaxed">
                Connect to the intelligent energy trading network and optimize
                your solar energy usage.
              </p>
            </div>
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-secondary-custom">
                    Monitor real-time energy trades, track your household's
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-secondary-custom">
                    Get intelligent recommendations for energy trading and
                    battery management
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-secondary-custom">
                    Access detailed insights on grid stability, trading volumes,
                    and carbon savings
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-secondary-custom">
                    Track your trading performance and energy optimization over
                    time
                  </p>
                </div>
              </div>
