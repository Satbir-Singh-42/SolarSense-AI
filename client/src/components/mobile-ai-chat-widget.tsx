    ...
    return [
      {
        id: 1,
        message:
          "Hello! I'm your SolarSense AI assistant ready to help with energy trading and optimization. Ask about energy flow, trading strategies, or grid management.",
        sender: "ai",
        timestamp: new Date(),
      },
    ];
    ...
    <div className="fixed bottom-4 right-4 z-[9999]">
      ...
      {isOpen && (
        <div className="absolute bottom-16 right-0 mb-2" ref={widgetRef}>
          <Card
            className={`w-[calc(100vw-2rem)] max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg transition-all duration-300 h-[60vh] sm:h-[70vh] max-h-80 sm:max-h-96 md:max-h-[500px] shadow-2xl drop-shadow-lg rounded-lg bg-slate-900/95 backdrop-blur-sm border border-slate-700/50`}>
                        ...
                        {msg.sender === "ai" && typingMessageId !== msg.id && (
                          <div className="flex justify-end mt-2">
                            <Button
                              ...
                              <Copy
                                className={`h-3 w-3 ${copiedMessageId === msg.id ? "text-green-400" : "text-slate-400"}`}
                              />
                            </Button>
                          </div>
                        )}
